...
public class GamePlay extends JPanel implements ActionListener{
    ...
    private ImageIcon imgbg = new ImageIcon(this.getClass().getResource("../img/bgplay.jpg"));
    private ImageIcon imgPause = new ImageIcon(this.getClass().getResource("../img/pause.png"));
    private ImageIcon imgPlay = new ImageIcon(this.getClass().getResource("../img/play.png"));
    
    public ImageIcon gameOver = new ImageIcon(this.getClass().getResource("../img/gameOver.jpg"));
    public ImageIcon imgreplay = new ImageIcon(this.getClass().getResource("../img/replay.png"));
